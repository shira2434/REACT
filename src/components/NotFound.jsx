...
const NotFound = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: '100px' }}>{s.notFoundEmoji || '🔍'}</div>
      <h1 style={{ fontSize: '80px', fontWeight: 'bold', color: '#0891b2', margin: 0 }}>404</h1>
      <h2 style={{ fontSize: '28px', color: '#1f2937', margin: 0 }}>{s.notFoundTitle || 'הדף לא נמצא'}</h2>
      <p style={{ color: '#6b7280', fontSize: '16px', maxWidth: '400px' }}>
        {s.notFoundText || 'הדף שחיפשת לא קיים. אולי הקישור שגוי או שהדף הוסר.'}
      </p>
      <button
